...
Product* ProductParser::parse(istream& is,
                              bool& error,
                              string& errorMsg,
                              int& lineno)
{
    ...
    return parseSpecificProduct(is, error, errorMsg, lineno);
}
...
Product* ProductBookParser::parseSpecificProduct(std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
{
...
Product* ProductClothingParser::parseSpecificProduct(std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
{
...
Product* ProductMovieParser::parseSpecificProduct(std::istream& is,
        bool& error,
        std::string& errorMsg,
        int& lineno)
{
